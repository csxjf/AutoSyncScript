...
##############################  作  者  脚  本  名  称  （必填）  ##############################
# 将相应作者的脚本填写到以下变量中
my_scripts_list_1="z_fanslove.js z_health_community.js z_health_energy.js z_marketLottery.js z_shae.js z_carnivalcity.js z_shop_captain.js z_xmf.js z_mother_jump.js z_wish.js"
my_scripts_list_2="monk_inter_shop_sign.js monk_shop_follow_sku.js monk_shop_lottery.js adolf_oppo.js adolf_pk.js adolf_martin.js adolf_mi.js adolf_urge.js"
