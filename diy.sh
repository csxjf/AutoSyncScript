...
my_scripts_list_2="monk_inter_shop_sign.js monk_shop_follow_sku.js monk_shop_lottery.js adolf_oppo.js adolf_newInteraction.js adolf_pk.js adolf_martin.js adolf_mi.js adolf_urge.js adolf_superbox.js"
